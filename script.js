...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.about-text, .about-visual, .product-text, .product-visual, .contact-info, .contact-form');
    ...
    socialLinks.forEach(link => {
        link.addEventListener('mouseenter', function() {
            const platform = this.querySelector('i').className.includes('twitter') ? 'Twitter' :
                           ...
                           this.querySelector('i').className.includes('github') ? 'GitHub' : 'Social';
